...
const ProductDetails = ({ productSlug }: { productSlug: string }) => {
  ...
  if (loading) {
    return (
      <>
        <Breadcrumb title={"Loading..."} pages={["product"]} />
  ...
  if (error) {
    return (
      <>
        <Breadcrumb title={"Error"} pages={["product"]} />
        <div className="flex justify-center items-center min-h-[400px]">
  ...
  if (!product || product.id === 0) {
    return (
      <>
        <Breadcrumb title={"Product Not Found"} pages={["product"]} />
        <div className="flex justify-center items-center min-h-[400px]">
                  ...
                  >
                    <g clipPath="url(#clip0_375_9221)">
                      <path
                        ...
                        fill={product.stock > 0 ? "#22AD5C" : "#DC2626"}
                      />
                      <path
                  ...
                  <button
                    onClick={async (e) => {
                      ...
                      try {
                        ...
                        // No toast lib in this file; simple alert to avoid extra deps
