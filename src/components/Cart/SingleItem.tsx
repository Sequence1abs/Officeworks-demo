...
const SingleItem = ({ item }) => {
  ...
  const handleIncreaseQuantity = async () => {
    ...
    try {
      await dispatch(updateCartItemAsync({ id: item.id, quantity: newQuantity })).unwrap();
    } catch (error) {
  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-5 px-7.5">
      ...
      <div className="min-w-[180px]">
        <p className="text-dark">LKR {item.discountedPrice}</p>
      </div>
      ...
      <div className="min-w-[275px]">
        <div className="w-max flex items-center rounded-md border border-gray-3">
          <button
            ...
            className={`flex items-center justify-center w-11.5 h-11.5 ease-out duration-200 ${isUpdating || quantity <= 1
          ...
          <button
            ...
            className={`flex items-center justify-center w-11.5 h-11.5 ease-out duration-200 ${isUpdating
                ? 'text-gray-400 cursor-not-allowed'
                : 'hover:text-blue'
              }`}
          >
      ...
      <div className="min-w-[200px]">
        <p className="text-dark">LKR {item.discountedPrice * quantity}</p>
      </div>
      ...
      <div className="min-w-[50px] flex justify-end">
        <button
          ...
          className={`flex items-center justify-center rounded-lg max-w-[38px] w-full h-9.5 border ease-out duration-200 ${isRemoving
